...
const Hero = () => {
    return (
        <section className="w-full py-12">
                <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center md:items-stretch gap-1">
                <div className="w-full md:w-1/2 flex justify-center">
                    <div className="bg-white rounded-xl p-6 md:p-8 shadow-xl ring-1 ring-gray-100 transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 hover:scale-[1.01] w-full max-w-md text-center" style={{textShadow: '0 6px 18px rgba(0,0,0,0.06)'}}>
