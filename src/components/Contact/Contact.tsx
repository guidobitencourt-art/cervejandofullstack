...
const Contact = () => {
  return (
    <section className="w-full py-12">
      <div className="max-w-6xl mx-auto px-6 grid gap-8 md:grid-cols-2 items-stretch">

        <div className="w-full">
          <div className="w-full h-64 md:h-96 bg-gray-100 rounded-xl overflow-hidden shadow-xl">
            <iframe
        ...
        <div className="w-full">
          <div className="bg-white rounded-xl p-4 shadow-xl h-64 md:h-96 flex items-center">
            <div className="w-full">
              ...
              <form id="contactForm" className="flex flex-col gap-3 h-full justify-center" action="#" method="GET">
